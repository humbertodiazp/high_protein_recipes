...
ingredients_array = Ingredient.create([
    { description: '2 chicken breast', quantity: '', measurement: '', recipe: recipes.fifth },
    { description: '1 tsp olive oil', quantity: '', measurement: '', recipe: recipes.fifth },
    { description: '1/2 tsp salt', quantity: '', measurement: '', recipe: recipes.fifth },
    { description: '1/2 tsp pepper', quantity: '', measurement: '', recipe: recipes.fifth },
    { description: '1/2 tsp chili powder', quantity: '', measurement: '', recipe: recipes.fifth },
